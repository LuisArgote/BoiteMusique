### Do not modify: edit Makefile instead       ###
### Unless you REALLY KNOW what you are doing  ###

LDSCRIPT = link/STM32F446RET6_FLASH.ld
...
LINKFLAGS = -Xlinker -Map=$(MAP) -u _printf_float
...
$(CRCOBJOK) : $(BIN).nocrc $(CRCSRC)
	@echo -n "COMPUTE CRC : ";\
	 CRC_LINE="$(shell python3 $(TOOLSDIR)/stm32-crc $<)";\
	 echo -n "$$CRC_LINE\n";\
...
load: $(ELF) $(BIN)
	...
	@STM32_Programmer_CLI -c port=SWD -d $(ELF) -s

debug: $(ELF) load
	@echo "DEBUG $<"
	@bash $(TOOLSDIR)/stm32-debug $<

txtdebug: $(ELF) load
	@echo "DEBUG $<"
	@bash $(TOOLSDIR)/stm32-gdb $<
